...
L.ICT.Func.add("AreaFlow",{
     ...
     Class: L.Class.extend({
        ...
        initialize:function(){
           ...
           this.ajax.setTimeout(10*60*1000);  
        ...
        _initEvts:function(){
          ...
          var startTime = self.dateUtil.getNewDateTimeBeforHour(24);
        ...
        sendAjax:function(data){
            this._loading = new L.ICT.Control.Loading().addTo(this._resultPopPanel.getContainer().find(".container-content"));
            this._loading.show();
        ...
        getstasticTableHtml:function(data){
           ...
           for(var i=0,len=enterList.length;i<len;i++){
              ...
              var coname = window.localStorage.getItem("language") === 'en' ? eobj.co_English : eobj.co;
              html.push('<tr>');
           ...
           for(var i=0,len=outList.length;i<len;i++){
              ...
              var coname = window.localStorage.getItem("language") === 'en' ? otbj.co_English : otbj.co;
              html.push('<tr>');
              html.push('<td>'+'<img src="themes/images/filterdisplay/country_'+ countryimg +'.png">'+ coname +'</td>');
