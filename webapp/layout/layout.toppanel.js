    ...
    L.ICT.Layout.TopPanel = L.ICT.Layout.extend({
        ...
        _bindEvts:function(){
            ...
            _this._container.find(".searchType").on("change",function(e){
                var type = $(this).val();
                if(type === '1'){
                    _this._container.find(".toppanel_keysearch_remind").attr("placeholder",$.i18n.prop('func_keysearch_ship_error1'));  
                }else {
                    _this._container.find(".toppanel_keysearch_remind").attr("placeholder",$.i18n.prop('func_keysearch_port_error1'));  
                }
            });
