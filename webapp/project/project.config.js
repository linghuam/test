...
var Project_ParamConfig = {
    ...
    */
    ...
    tshfConfig:{
        playbackList:[],
        limit:20,//条数限制
        areaUrl:'http://'+ DefaultIP +':'+ DefaultPORT +'/hdsample/track/areaships.do',//指定区域
    ...
    //实时目标显示配置
    RealTargetConfig:{
        showLevel:8, //实时目标显示的最小级别【8级或8级以上为合理区间】
        ...
        timeout:10000,//消批时间分钟【待确认】
        updatetime:10,//规定多长时间(单位：秒)更新一下数据
        ...
        rasterUrl:'http://'+ DefaultIP +':'+ DefaultPORT +'/hdsample/buildTableImageData.do',//栅格图地址
    ...
    FilterDisplayConfig:{    
        ...
        shipTypeList:["1","3","6","5","7","8","100"], //st
        //"1":中国","2":"英国","3":"法国","4":"美国",“5”：俄罗斯，"100":"其他"
        shipFlagList:["1","2","3","4","100"],
        //"0":机动船在航,"1":锚泊,"2"：船舶失控,"3"：船舶操作受限
    ...
    //统计分析
    StasticConfig:{
        areaflowUrl:'http://'+ DefaultIP +':'+ DefaultPORT +'/hdsample/portHistoryInformationStatistics.do'
    }
