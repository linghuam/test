    ...
    /*地图类*/	
     L.ICT.Map = L.ICT.BaseObject.extend({
        ...
        OperateState:{
            ...
            //         .on("viewreset",function(){console.log("viewreset");},this)
            //         .on("zoomstart",function(){console.log("zoomstart");},this)
            //         .on("zoomend",function(){console.log("zoomend");},this)
            //         .on("movestart",function(){console.log("movestart");},this)
            //         .on("moveend",function(){console.log("moveend");},this)
            //         .on("zoomlevelschange",function(){console.log("zoomlevelschange");},this)
            ...
            /********test ajax_poll start*********/
             // $.poll({
             //  url: "http://10.5.0.138:8080/rest/abnormal/getzoneentry.do",
             //  data:{tim:1488767835},
             //  method:'POST',              
             //  pollDelay: 5000,
             //  pollLoops: 15,
        ...
        _moveendEvt:function(e){
           ...
           if(this.OperateState.wjfx){return;}
           if(this.OperateState.wjfx_hdyc){return;}
        ...
        _mapClickEvt:function(e){
           // alert("latlng:"+e.latlng.toString()+"\n");
           // var pj = this.map.project(e.latlng);
           // console.log("project:"+pj.toString());
           // console.log("layerPoint:"+e.layerPoint.toString()+"\n");
           // console.log("containerPoint:"+e.containerPoint.toString()+"\n");
