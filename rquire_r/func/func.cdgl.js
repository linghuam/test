    ...
    L.ICT.Func.add("cdgl",{
        ...
        Class: L.Class.extend({
            ...
            _getContentHtmlDialogShipFleetAddEdit:function () {
                ...
                html.push('	</TR>');
                html.push('	<TR>');
                html.push('		<TD style="width:390px;height:20px;line-height:20px;text-align:left;vertical-align:middle;padding-left:20px;" colspan="2">');
                html.push('			<input type="text" id="cdgl_addeditfleet_inputfleenametip" class="cdgl_font_error" readonly="true" style="width:100%;padding-left:10px;"/>');
                html.push('		</TD>');
                html.push('	</TR>');
                html.push('	<TR>');
                html.push('		<TD style="width:95px;height:30px;text-align:right;vertical-align:middle;">');
            ...
            _getContentHtmlDialogDel:function (isFleet) {
                ...
                html.push('			<img src="./themes/images/baoChuan/error.png" style="width:40px;height:40px;"><label class="cdgl_labelfont">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp'+func_cdgl_msg_tip_del+'</label>');
                html.push('		</TD>');
                html.push('	</TR>');
                html.push('	<TR>');
            ...
            _showEventListSucess:function (data) {
                ...
                if (reclist.length==0){
                    ...
                    this._showMsg(func_cdgl_msg_tip_event_noseachresult);
                }
            },
