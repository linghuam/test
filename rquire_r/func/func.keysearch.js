     ...
     Class: L.Class.extend({
        ...
        getTableHtml:function(data){
            ...
            for (var i=0,len=listinfo.length;i<len;i++){
                ...
                html.push('<td>'+'IMO:'+ onetarget.cs +'</td>');                
                html.push('</tr>');
            }
            html.push('</table></div>');
            return html.join("");
        ...
        convertOneTargetFromObj:function(oneinfo){
            ...
            onetarget.cs = oneinfo.cs.replace(/@/g,""); //呼号
            onetarget.sn = oneinfo.sn.replace(/@/g,""); //船名
            onetarget.id = oneinfo.num; 
...
//                switch (searchType){
//                 case "船舶": 
//                     this.ictmap.realtarget.locateByShipMSI(this.param.searchText);
//                     break;
//                 case "港口": 
//                     this.ictmap.portlayer.locateByPortId(this.param.searchText);
//                     break;
//                 default:;
//                }
//                 // this.ajaxCount = 0;
//                 // this.data={};
//                 // this.data.type=5 || searchType; //test
//                 // this.data.num=this.param.searchText;   
//                 // this.data.mode=1;  //test                  
//                 // this.data.pageid=this.curPage;
//                 // this.data.pagecount=this.perPageCount;
//                 // this.searchAjax(this.data);
//             },
...
//                         var onetarget=this.convertOneTargetFromObj(listinfo[i]);    
//                         var num = onetarget.mmsi;
//                         var tdtext='MMSI:'+onetarget.mmsi;
//                         reshtml.push('<tr data-id="'+num+'"><td>'+tdtext+'</td></tr>');
//                     }
...
//                     var num = onetarget.mmsi;
//                     var tdtext='MMSI:'+onetarget.mmsi;
//                     html.push('<tr data-id="'+num+'"><td>'+tdtext+'</td></tr>');
//                 }
//                 html.push('</table></div>');
//                 html.push('</div>');
//                 html.push('<div class="pageContainer"></div>');
...
//             locateMarker:function(shipobj){

//             },

//             createMarker:function(shipobj){
