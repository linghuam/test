class EquipmentAnalysis {
    ...
    getNodes() {
        var nodes = [];
        var select_nodes = this._nodesData.where(o => o.selected_equipment === this._selectTagName);
    ...
    getLinks() {
        var links = [];
        var select_links = this._linkData.where(o => o.selected_equipment === this._selectTagName);
