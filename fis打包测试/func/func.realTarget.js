   ...
   L.ICT.RealTarget = L.Class.extend({
        ...
        getTargetIcon:function(type){
           ...
           switch (type){
             ...
             case "搜救船": icon=L.ICT.ShipIcon.ship8 ;break;
             case "油轮": icon=L.ICT.ShipIcon.ship2 ;break;
             case "拖船": icon=L.ICT.ShipIcon.ship3 ;break;
             case "渔船": icon=L.ICT.ShipIcon.ship4 ;break;
             case "客船": icon=L.ICT.ShipIcon.ship5 ;break;
             case "军事船": icon=L.ICT.ShipIcon.ship6 ;break;                                             
             case "其他": icon=L.ICT.ShipIcon.ship7 ;break;
        ...
        locateShip:function(data){
            ...
            if(layer){   
                ...
                this.ajaxLocateShip.post(url,data,true,this,function(res){
                   if(res.state !== 1){ 
        ...
        isShowNewTarget:function(obj){             
            return !this.ictmap.OperateState.tshf 
                  // && !this.ictmap.OperateState.port 
                  && !this.ictmap.OperateState.wjfx 
                  && !this.ictmap.OperateState.wjfx_hdyc 
        ...
        _markerClickEvt:function(event){
            ...
            this.ajaxShipInfo.post(url,data,true,this,function(res){
               if(res.state !== 1){              
                  L.ict.app.util.dialog.error("提示","获取指定船舶信息失败！");
                  this.removeShipInfoPopPanel();                 
               }else{
        ...
        getDetialConvertName:function(code,type){
            ...
            if (type=="ship_type"){//船舶类型
              ...
              switch(code){
                ...
                case "4": res = "受吃水限制，船舶行动受限";break;
                case "5": res = "系泊";break;
                case "6": res = "搁浅";break;
                case "7": res = "从事捕捞";break;
                case "8": res = "船舶在航";break;
                default: res = "未知"; 
              }
