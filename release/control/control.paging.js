...
*页码切换控件
*@module controls
*@class ICT.Controls.Paging
*@extends ICT.BaseObject
*@example
    var container = $('#div_paging')[0];
    var paging = new L.ICT.Control.Paging({ total: 12, 
                                             count: 5, 
                                             present: 2, 
...
define("control/paging", [
 ...
 L.ICT.Control.Paging = L.ICT.BaseObject.extend({
        /**
        *类标识
        *@property id
        *@type {String}
        */
        id: 'L.ICT.Control.Paging',
