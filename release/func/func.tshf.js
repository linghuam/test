  ...
  L.ICT.Func.add("TSHF",{
    ...
    Class:L.Class.extend({
       ...
       _initAreaEvts:function(){
           ...
           //加载动画
           this._loading = new L.ICT.Control.Loading().addTo(this._areaPanel.getContainer().find(".container-content"));
      ...
      //指定目标事件
       ...
       playBack:function(data){
           //回放前处理
           if(this._targetPanel) this._targetPanel.close();
           if(this._areaPanel) this._areaPanel.close();        
